...
import { SET_FORECAST_DATA, GET_WEATHER_CITY, SET_WEATHER_CITY } from './../actions'; //Accion que estamos atendiendo.

export const cities = (state = {}, action) => {//nmbre del reducer
    switch (action.type) {
        case SET_FORECAST_DATA : {
            const { city, forecastData } = action.payload;
            return {...state, [city]: { ...state[city], forecastData, forectastDataDate: new Date() }}
        }
